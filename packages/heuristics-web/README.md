[![npm (tag)](https://img.shields.io/npm/v/@concordialang-healer/heuristics-web?color=blue&style=flat-square)](https://www.npmjs.com/package/@concordialang-healer/heuristics-web)
